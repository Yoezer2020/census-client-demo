...
export default function CIDAdultGuide() {
  return (
          ...
          <div className="lg:sticky lg:top-6 space-y-6 self-start">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-xl border border-gray-100">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="text-2xl font-black text-black">2 Days</div>
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="text-2xl font-black text-black">10 Years</div>
                  <p className="text-xs text-gray-500 mt-1">
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                  ...
                  <div className="text-2xl font-black text-black">Nu. 100</div>
                  <p className="text-xs text-gray-500 mt-1">
            ...
            <div className="bg-gray-100 rounded-2xl p-6 border border-gray-200 shadow-2xl">
              ...
              <p className="text-xs text-black leading-relaxed mb-4">
                Questions? Contact our nearest service center for expert
                guidance.
              </p>
              <Link
                href="/contact"
