    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <Label
              htmlFor="point_of_application_dzongkhag"
              className="text-sm font-semibold text-gray-700"
            >
              Dzongkhag/Dungkhag/Thromde <span className="text-red-500">*</span>
            </Label>
            <Select
            ...
            >
              <SelectTrigger
                id="point_of_application_dzongkhag"
          ...
          <div className="space-y-2">
            <Label
              htmlFor="point_of_application_gewog"
              className="text-sm font-semibold text-gray-700"
            >
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="mewang-thimphu">Mewang (Thimphu)</SelectItem>
                ...
                <SelectItem value="phobji-wangdue">Phobji (Wangdue)</SelectItem>
              </SelectContent>
            </Select>
            {errors.point_of_application_gewog && (
              <p className="text-red-500 text-xs font-semibold">
